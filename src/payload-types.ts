...
export interface Author {
  ...
  name: string;
  /**
   * Job title shown alongside the author byline, e.g. "Creative Director".
   */
  role?: string | null;
...
export interface Project {
  ...
  /**
   * Key metrics/results shown on the project detail page.
   */
  stats?:
    | {
        label: string;
...
export interface FeatureGridBlock {
  ...
  features?:
    | {
        icon: 'Sparkles' | 'Zap' | 'Shield' | 'Layers' | 'Rocket' | 'Target' | 'Gauge' | 'Palette';
        title: string;
        description: string;
        id?: string | null;
      }[]
...
export interface SiteSetting {
  ...
  /**
   * Used as the fallback Open Graph image when a page/post has none set.
   */
