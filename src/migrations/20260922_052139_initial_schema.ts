...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_feature_grid_features_icon" AS ENUM('Sparkles', 'Zap', 'Shield', 'Layers', 'Rocket', 'Target', 'Gauge', 'Palette');
  CREATE TYPE "public"."enum_pages_blocks_image_text_media_position" AS ENUM('left', 'right');
  CREATE TYPE "public"."enum_pages_blocks_image_text_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_image_text_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_pricing_tiers_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_pricing_tiers_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_project_grid_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum_pages_blocks_project_grid_relation_to" AS ENUM('projects');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_feature_grid_features_icon" AS ENUM('Sparkles', 'Zap', 'Shield', 'Layers', 'Rocket', 'Target', 'Gauge', 'Palette');
  CREATE TYPE "public"."enum__pages_v_blocks_image_text_media_position" AS ENUM('left', 'right');
  CREATE TYPE "public"."enum__pages_v_blocks_image_text_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_image_text_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_pricing_tiers_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_pricing_tiers_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_project_grid_populate_by" AS ENUM('collection', 'selection');
  CREATE TYPE "public"."enum__pages_v_blocks_project_grid_relation_to" AS ENUM('projects');
  ...
  CREATE TABLE "pages_blocks_image_text" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"media_id" integer,
  	"media_position" "enum_pages_blocks_image_text_media_position" DEFAULT 'right',
  	"eyebrow" varchar,
  	"rich_text" jsonb,
  	"enable_link" boolean,
  	"link_type" "enum_pages_blocks_image_text_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_image_text_link_appearance" DEFAULT 'default',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "pages_blocks_pricing_tiers" (
  	...
  	"link_type" "enum_pages_blocks_pricing_tiers_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_pricing_tiers_link_appearance" DEFAULT 'default'
  );
  ...
  CREATE TABLE "pages_blocks_project_grid" (
  	...
  	"id" varchar PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum_pages_blocks_project_grid_populate_by" DEFAULT 'collection',
  	"relation_to" "enum_pages_blocks_project_grid_relation_to" DEFAULT 'projects',
  ...
  CREATE TABLE "_pages_v_blocks_image_text" (
  	...
  	"id" serial PRIMARY KEY NOT NULL,
  	"media_id" integer,
  	"media_position" "enum__pages_v_blocks_image_text_media_position" DEFAULT 'right',
  	"eyebrow" varchar,
  	"rich_text" jsonb,
  	"enable_link" boolean,
  	"link_type" "enum__pages_v_blocks_image_text_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_image_text_link_appearance" DEFAULT 'default',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_pricing_tiers" (
  	...
  	"description" varchar,
  	"featured" boolean DEFAULT false,
  	"link_type" "enum__pages_v_blocks_pricing_tiers_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_pricing_tiers_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_project_grid" (
  	...
  	"id" serial PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum__pages_v_blocks_project_grid_populate_by" DEFAULT 'collection',
  	"relation_to" "enum__pages_v_blocks_project_grid_relation_to" DEFAULT 'projects',
  	"limit" numeric DEFAULT 6,
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  ALTER TABLE "pages_blocks_image_text" ADD CONSTRAINT "pages_blocks_image_text_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_image_text" ADD CONSTRAINT "_pages_v_blocks_image_text_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_image_text_media_idx" ON "pages_blocks_image_text" USING btree ("media_id");
  ...
  CREATE INDEX "_pages_v_blocks_image_text_media_idx" ON "_pages_v_blocks_image_text" USING btree ("media_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_pages_blocks_image_text_media_position";
  DROP TYPE "public"."enum_pages_blocks_image_text_link_type";
  DROP TYPE "public"."enum_pages_blocks_image_text_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_pricing_tiers_link_type";
  DROP TYPE "public"."enum_pages_blocks_pricing_tiers_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_project_grid_populate_by";
  DROP TYPE "public"."enum_pages_blocks_project_grid_relation_to";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_image_text_media_position";
  DROP TYPE "public"."enum__pages_v_blocks_image_text_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_image_text_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_pricing_tiers_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_pricing_tiers_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_project_grid_populate_by";
  DROP TYPE "public"."enum__pages_v_blocks_project_grid_relation_to";
